...
class GcsPlacementGroupSchedulerTest : public ::testing::Test {
 public:
  void SetUp() override {
    ...
    ccm_ = std::make_shared<rpc::ClientCallManager>(io_service_);
    raylet_client_pool_ = std::make_shared<rpc::NodeManagerClientPool>(*ccm_);
 ...
 protected:
  ...
  std::shared_ptr<rpc::ClientCallManager> ccm_;
